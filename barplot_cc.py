...
fig_enthalpy.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Reaction Enthalpy across DFT Methods and<br>Experimental Data_correction-correlated",
...
# Save as PNG
fig_enthalpy.write_image("bar_plot_cc_enthalpy.png", format="png", scale=5)

# save a html
import plotly.io as pio
pio.write_html(fig_enthalpy, 'bar_enthalpy_cc.html', auto_open=False, )
...
fig_gibbs.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Change in Gibbs Free Energy across DFT Methods_correction-correlated",
        font=dict(size=22, family="Arial, sans-serif", color="black"),
        x=0.5, y=0.97,  # Center the title
    ),
    xaxis=dict(
...
# Save as PNG
fig_gibbs.write_image("bar_plot_cc_gibbs.png", format="png", scale=5)

# save a html
import plotly.io as pio
pio.write_html(fig_enthalpy, 'bar_gibbs_cc.html', auto_open=False, )
...
fig_entropy.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Change in Entropy across DFT Methods_correction-correlated",
        font=dict(size=22, family="Arial, sans-serif", color="black"),
        x=0.5, y=0.97,  # Center the title

    ),
    xaxis=dict(
        title="Change in Entropy (cal/mol·K)",
        titlefont=dict(size=18, family="Arial, sans-serif", color="black"),
        tickfont=dict(size=16, family="Arial, sans-serif"),
        range=(0,-0.13),
    ),
...
# Save as PNG
fig_entropy.write_image("bar_plot_cc_entropy.png", format="png", scale=5)

# save a html
import plotly.io as pio
pio.write_html(fig_enthalpy, 'bar_entropy_cc.html', auto_open=False, )
