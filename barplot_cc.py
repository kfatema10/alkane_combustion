...
fig_enthalpy.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Reaction Enthalpy across DFT Methods and<br>Experimental Data_correlation-consistent",
...
fig_gibbs.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Change in Gibbs Free Energy across DFT Methods_correlation-consistent",
        font=dict(size=22, family="Arial, sans-serif", color="black"),
        x=0.5, y=0.97,  # Center the title
    ),
    xaxis=dict(
...
fig_entropy.update_layout(
    ...
    bargap=0.3,
    title=dict(
        text="Comparison of Change in Entropy across DFT Methods_correlation-consistent",
        font=dict(size=22, family="Arial, sans-serif", color="black"),
        x=0.5, y=0.97,  # Center the title
