...
fig1.update_layout(
    ...
    title=dict(
                text="Linear Fit of Reaction Enthalpies_correction-correlated",
...
fig2.update_layout(
    width=1000, height=700,
    title=dict(
                text="Linear Fit of Change in Gibbs Energy_correction-correlated",
                font=dict(size=22, family="Arial", color="black"),
                x=0.5, y=0.97,  # Center the title
                ),
    font=font_style,
...
fig3.update_layout(
    width=1000, height=700,
    title=dict(
                text="Linear Fit of Reaction Entropies_correction-correlated",
                font=dict(size=22, family="Arial", color="black"),
                x=0.5, y=0.97,  # Center the title
                ),
