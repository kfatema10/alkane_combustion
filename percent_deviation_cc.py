...
fig.update_layout(width = 800, height = 600,
    title=dict(
        text="Percent Deviation in Reaction Enthalpy_correlation-consistent",
    ...
    legend=dict(
        ...
        itemwidth=35,                            # Adjust the width of items inside the legend
    ),
...
fig.write_image("percent_deviation_enthalpy_cc.png", format="png", scale=5)


# save a html
import plotly.io as pio
pio.write_html(fig, 'percent_deviation_cc_enthalpy.html', auto_open=False, )