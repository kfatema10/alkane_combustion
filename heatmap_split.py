...
fig = go.Figure(data=go.Heatmap(
    ...
    colorscale="viridis_r",   # viridis, magma 
    # colorscale = [[0, 'hsl(60, 100.00%, 51.60%)'], [1, 'rgb(41, 2, 2)']],
    # colorscale = [[0, 'rgba(243, 243, 26, 0.71)'], [1, 'rgb(129, 2, 2)']],
    colorbar=dict(title="Deviation<br>(kcal/mol)")
))

fig.update_layout(
            title=dict(text="Deviations in Enthalpy (Computational - Experimental)_split-valence",
...
fig.write_image("heatmap_enthalpy_split.png", format="png", scale=5)

# save a html
import plotly.io as pio
pio.write_html(fig, 'heatmap_enthalpy_split.html', auto_open=False, )
